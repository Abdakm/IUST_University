...
export default function LinkBox(props) {
	return(
		<button data-index={props.keys} data-show={props.show} onClick={props.toggle} className={`flex items-center gap-8 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 ${props.styles}`}>
